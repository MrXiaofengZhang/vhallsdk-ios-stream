...
#import "VHallSDK/VHallOpenLivePublish.h"
...
@property (strong, nonatomic)VHallOpenLivePublish *engine;
...
- (IBAction)startPlayer
{
    if (!_isStart)
    {
       ...
       [_engine startLiveWithId:_roomId token:self.token];
...
- (void)initCameraEngine
{
    ...
    self.engine = [[VHallOpenLivePublish alloc] initWithOrgiation:deviceOrgiation];
